...
#Query 9: Return the list of courses with attendance less than 70%
...
#Query 10: Delete all records of students that passed out from the institute 
...
#Testing code:
#register()                              
#print(hasStudentregisted(17070122012)) 
#print(countLecturesAttended(17070122026, 70122503))
